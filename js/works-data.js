...
const WORKS = [
  {
    ...
    process: [
      {
        heading: "制作背景 / コンセプト",
        body: "「シュルレアリスム」をテーマにしたゲーム作品で、企画・モデリング・プログラミング・音楽・アニメーション制作など全ての制作を一人で行いました。ゲーム自体はシンプルで、プレイヤーは前を歩く女性のキャラクターをひたすら追いかけます。その中でシュルレアリスム的な精神の世界に迷い込んでいくという内容で、映像とゲームの中間点となるような作品を目指して制作しました。",
        images: [
      ...
      {
        heading: "UE5 レベルデザイン",
        body: "背景を全てBlenderでモデリングし、UnrealEngine5でゲームにしました。レベルごとに世界観が異なるように意識してモデリングしました。また、直線を多用したレベルは人工的な印象を強め、曲線を多用したレベルは幻想的な世界観を表現しました。プレイヤーが進むにつれてステージが変化するような設計を全てBlueprintで実装し、「他では感じたことがないような体験をした」という感想をもらうことができました。",
        naturalHeight: true,
        columns: 2,
        images: [
      ...
      },
      {
        ...
        body: "プレイヤーの前を歩き続ける女性を追いかけるという点が今作の核です。レベルにスプラインを設置し、そのスプライン上を動くアクターをAI Controllerで追いかけ続けるキャラクターを実装することで、まるでプレイヤーの前を歩いているかのように見せました。また、キャラクターはStable DiffusionとTripoで3D生成し、デフォルトのマネキンにリターゲットして実装。Behavior TreeとBlackboardを組み合わせて制御しました。",
        images: [
      ...
      },
      {
        ...
        body: "各レベルに異なる世界観のNPCを配置し、すれ違うと会話が表示される仕組みをデータテーブル＋接触判定トリガーで実装しました。アニメーションはBlenderで制作しFBXでインポート。UIはゲーム未経験者でも直感的に操作できるよう意識してデザインしました。レベル遷移時のローディング画面も自作アニメーションをWidgetで再生し、没入感を維持する設計にしました。",
        images: [
  ...
  },
  {
    ...
    process: [
      {
        heading: "制作背景 / コンセプト",
        body: "ヨルゴス・ランティモス監督の映画『哀れなるものたち』の背景美術に心を惹かれ、その1920年代の退廃的な街の世界観を3DCGで再現することに挑戦しました。商業利用も可能なレベルのクオリティを目標に、細かいところまで丁寧に制作しました。不思議な街の奥へと引き込まれるような画作りを目指し、画面奥へと視線が向かう構図を意識しました。",
        images: [
      ...
      },
      {
        ...
        body: "Substance Painterを使い、その建物独自の汚れや質感を手描きで足したテクスチャを制作しました。マテリアルインスタンスで作ることで、質感の調整をパラメーターで細かく設定できるようにしました。リファレンスを参考にベースのテクスチャを設定した後、汚れや質感をブラシで手描きして足していく工程を繰り返しました。",
        images: [
      ...
      },
      {
        ...
        body: "制作途中の課題として「テクスチャのスケールが大きい」「反復感が気になる」「ベベルがないため角ばって見える」「テクスチャのラフネスが全て等しいため実在感に欠ける」などを洗い出し、人型モデルでスケール感の基準を作りながら一つひとつ修正しました。ライティングの問題で色が潰れている箇所も調整しました。",
        images: [
          "assets/works/Poor-Things/03.jpg",
          "assets/works/Poor-Things/04.jpg",
          "assets/works/Poor-Things/05.jpg",
      ...
      },
      {
        ...
        body: "環境光だけでは露出が潰れてしまう箇所が多かったため、ポイントライトを使って光の方向性に矛盾がないよう丁寧にライティング。UE5からEXR形式でレンダリングし、After Effectsでマルチパスコンポジットを実施。AEでEXRが上手く開けない問題も各種サイトを調べることで解決し、空間感を強調するコンポジットに仕上げました。",
        images: [
  ...
  },
  {
    ...
    process: [
      {
        heading: "テクスチャワーク",
        body: "テクスチャワークはSubstance Painterで行いました。室内のオブジェクトには詳細な模様をUVに直接投影する必要があり、素材ごとに異なる手法を選択しました。コップや瓶などのガラス類はBlenderのシェーダーで制作し、透明感だけでなく凹凸感もノードで調整して実在感を追求しました。",
        images: [
      ...
      {
        heading: "レンダリング",
        body: "レンダリングはBlenderのCyclesで実施しました。Cyclesは緻密な計算を得意としフォトリアルな表現に強いが、レイトレーシングの計算に時間がかかるため静止画向きです。各オブジェクトのポリゴン数はテーブルライト △4,408、地球儀 △14,708、椅子 △33,516、額縁 △47,100など、合計△279,602ポリゴンで構成しました。",
        images: [
    ...
    process: [
      {
        ...
        body: "手描きのイラストを3DCGでモデリングしたオブジェクトに投影することで、絵なのに奥行き感のある映像を作るという表現手法に挑戦した作品。❶Blenderで背景モデルを制作し、❷Clip Studioでペイントした背景イラストをUV投影。シェーダーを調整することで手描きテクスチャをマッピングし、独特の質感を実現しました。",
        images: [
    ...
    process: [
      {
        ...
        body: "日産株式会社の長期インターンシップ（7日間）で制作した課題作品。「指定のコンセプトカーをより魅力的に表現する映像の制作」というテーマに対し、車のコンセプトである「洗練さ」と「快適さ」を空間デザインで表現した。「洗練さ」には幾何形体、「快適さ」には緩やかな曲線を多用し、グリーンを基調とした照明と建築空間でラグジュアリーかつ都市的な世界観を演出しました。",
        images: [
  ...
  },
  {
    ...
    thumbnail: "./assets/works/texture-sketch/08.jpg",
    images: [
      "./assets/works/texture-sketch/08.jpg",
      "./assets/works/texture-sketch/02.jpg",
      "./assets/works/texture-sketch/03.jpg",
      "./assets/works/texture-sketch/04.jpg",
      "./assets/works/texture-sketch/05.jpg",
      "./assets/works/texture-sketch/06.jpg",
      "./assets/works/texture-sketch/07.jpg",
      "./assets/works/texture-sketch/01.jpg",
      "./assets/works/texture-sketch/09.jpg",
      "./assets/works/texture-sketch/10.jpg",
      "./assets/works/texture-sketch/11.jpg"
    ],
    colors: {
      '--color-bg': '#f8f8f4',
      '--color-text': '#262619',
